...
title: story creator
date: '2023-12-10'
description: A simple react app that creates a story using ChatGPT from user topics
categories: react
image: featured.png
format:
  html:
...
::: {.page-links}
<a class="page-link" href="https://mattkumar.github.io/react-app/"><i class="bi bi-braces"></i><span>View React App</span></a>
<a class="page-link" href="https://github.com/mattkumar/react-app/"><i class="bi bi-github"></i><span>View Repo</span></a>
:::
